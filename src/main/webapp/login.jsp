    ...
    <div class="form-container w-full max-w-md">
        <div class="bg-gray-900 bg-opacity-75 backdrop-blur-lg rounded-xl p-8 shadow-2xl border border-gray-700">
            ...
            <form action="login" method="post" class="space-y-6">
                ...
                <!--
                  KEY HTML CHANGE: Password Field
                  - The input is now inside a div with `position: relative`.
                  - The icon toggle button is placed absolutely inside this div.
                -->
                <div>
            ...
            <div class="text-center mt-6">
                <p class="text-sm text-gray-400">
                    ...
                    <a href="register" class="font-semibold text-purple-400 hover:text-purple-300 transition-colors duration-300">
                        Join the adventure
                    </a>
                </p>
            </div>
